...
export { assinaturaCompetencias } from './tables/assinatura_competencias/tabela'
export { assinaturaPagamentos } from './tables/assinatura_pagamentos/tabela'
export { assinaturaPagamentoAlocacoes } from './tables/assinatura_pagamento_alocacoes/tabela'
export { parceiroNiveis } from './tables/parceiro_niveis/tabela'
export { parceiroNivelConfiguracoes } from './tables/parceiro_nivel_configuracoes/tabela'
export { parceiroNivelRegras } from './tables/parceiro_nivel_regras/tabela'
export { parceiroNivelEstados } from './tables/parceiro_nivel_estados/tabela'
export { parceiroNivelHistorico } from './tables/parceiro_nivel_historico/tabela'
export { parceiroCampanhas } from './tables/parceiro_campanhas/tabela'
export { parceiroCampanhaContribuicoes } from './tables/parceiro_campanha_contribuicoes/tabela'
export { parceiroCampanhaRecompensas } from './tables/parceiro_campanha_recompensas/tabela'
export { parceiroBonus } from './tables/parceiro_bonus/tabela'
export { parceiroPontosLancamentos } from './tables/parceiro_pontos_lancamentos/tabela'
...
export { documentosFiscais } from './tables/documentos_fiscais/tabela'
export { documentosFiscaisRelations } from './tables/documentos_fiscais/relacoes'
export { documentosFiscaisEventos } from './tables/documentos_fiscais_eventos/tabela'
export { documentosFiscaisEventosRelations } from './tables/documentos_fiscais_eventos/relacoes'
export { documentosFiscaisArquivos } from './tables/documentos_fiscais_arquivos/tabela'
export { documentosFiscaisArquivosRelations } from './tables/documentos_fiscais_arquivos/relacoes'
export { documentosFiscaisExtracoes } from './tables/documentos_fiscais_extracoes/tabela'
export { documentosFiscaisExtracoesRelations } from './tables/documentos_fiscais_extracoes/relacoes'
export { documentosFiscaisPartes } from './tables/documentos_fiscais_partes/tabela'
export { documentosFiscaisPartesRelations } from './tables/documentos_fiscais_partes/relacoes'
export { documentosFiscaisItens } from './tables/documentos_fiscais_itens/tabela'
export { documentosFiscaisItensRelations } from './tables/documentos_fiscais_itens/relacoes'
export { documentosFiscaisTributos } from './tables/documentos_fiscais_tributos/tabela'
export { documentosFiscaisTributosRelations } from './tables/documentos_fiscais_tributos/relacoes'
