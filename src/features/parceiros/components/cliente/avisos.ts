/**
 * O rodapé que diz de onde vêm os números de cada tela do Programa de Parceiros.
 *
 * Três situações, e só três: tudo real, tudo demonstração, ou o nível real ao
 * lado de blocos que ainda são demonstração. Dado real chamado de demonstrativo
 * é tão enganoso quanto o contrário.
 */
