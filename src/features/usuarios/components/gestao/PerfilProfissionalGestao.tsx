...
export function PerfilProfissionalGestao({ dados }: { dados: Dados }) {
  ...
  return <main className="mx-auto min-h-dvh max-w-5xl px-4 py-8 sm:px-6"><Button asChild variant="ghost"><Link href="/gestao/usuarios"><ArrowLeft/>Voltar</Link></Button>
